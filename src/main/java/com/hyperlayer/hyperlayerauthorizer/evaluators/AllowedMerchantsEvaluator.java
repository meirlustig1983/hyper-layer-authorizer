...
@Slf4j
@Component
public class AllowedMerchantsEvaluator implements Evaluator {
    @Override
    public boolean evaluate(RewardRuleData rewardRuleData, DbCustomer dbCustomer, DbReward dbReward, DbMerchant dbMerchant, TransactionAuthorizationRequest request) {
        ...
        log.info("allowed merchants evaluate. merchantId: {}, allowed-merchants: {}, result: {}", request.merchantId(), values, result);
        return result;
    }
}